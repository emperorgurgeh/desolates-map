            ...
            <div className="pb-1 flex items-center lg:pt-0 lg:pb-0">
                ...
                <ul className="max-h-screen justify-around lg:flex lg:justify-start">
                    <div className="lg:flex lg:basis-1/4 lg:items-center">
                        ...
                        {/* Profile picture */}
                        <li className="">
                            <div className="flex justify-center pt-2 pb-2 lg:flex lg:basis-1/8 lg:mr-10">
                                <Image
                                    src={pic}
                    ...
                    <div className="min-h-0 max-h-screen  h-8 flex justify-end">
                        <button
                            className={`font-cool p-2 mr-3 text-sm text-center text-primary transition-colors duration-200 rounded-lg hover:text-white hover:bg-primary w-20 outline-cool backdrop-filter backdrop-blur bg-faded`}
                        >
                            CANCEL
                        </button>

                        <button
                            className={`font-cool p-2 text-sm text-center text-primary transition-colors duration-200 rounded-lg hover:text-white hover:bg-primary w-20 outline-cool backdrop-filter backdrop-blur bg-faded`}
                        >
                            SAVE
                        </button>
                    </div>
